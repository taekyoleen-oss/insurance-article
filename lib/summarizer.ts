...
1. **summary**: 글머리(•) 4줄, 줄당 한국어 55~80자
   - 1줄: 핵심 사실 (무엇이 변했는가/결정되었는가, 구체적 수치·기관명 포함)
   - 2줄: 배경 및 원인 (왜 이런 변화가 발생했는가)
   - 3줄: 업무 영향 (보험사 실무에 어떤 구체적 영향이 있는가)
   - 4줄: 시사점 또는 후속 동향 (향후 주목할 점, 대응 방향)
